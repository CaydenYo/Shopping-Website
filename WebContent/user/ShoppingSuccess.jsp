		...
		<center>
			<div style="width: 1200px; text-align: center;">
				...
				<table border="0" cellpadding="0" cellspacing="0" id="t">
					<font color="red">您的预定已成功</font>
					<br>
					<ul>
						<li>订单号<font color="red">${latestorder.oid }</font></li>
						<li>订单生成时间：<font color="red">${latestorder.commitTime }</font></li>
						<li>成交金额：<font color="red">${latestorder.amount }</font></li>
						<li>以下是该订单详细信息：</li>
					</ul>
					<br>
