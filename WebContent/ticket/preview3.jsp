				...
				<div class="cont-desc span_1_of_2">
					<div class="product-details">
						<div class="grid images_3_of_2">
							<img src="/EBP_19/images/31.jpg" alt="" />
						</div>
						<div class="desc span_3_of_2">
							<h2>美女与野兽</h2>
							<p>为了解救触怒野兽的父亲，勇敢善良的贝儿只身一人来到古堡，代替父亲被囚禁其中。贝儿克服了恐惧，和城堡里的魔法家具们成为了朋友，也渐渐发现野兽其实是受了诅咒的王子，他可怕的外表下藏着一颗善良温柔的内心。</p>
							<div class="price">
								<p>
									单价: <span>${buytickesurface.get(2).price}</span>
								</p>
							</div>
							<div class="available">
								<ul>
									<li><span>剩余票数:</span>&nbsp;
										${buytickesurface.get(2).balance}</li>
								</ul>
							</div>
							<div class="share-desc">
								<div class="share">
									...
									<input class="text_box" type="text"
										id="amount${buytickesurface.get(2).tid}">
								</div>
								<c:if test="${not empty session_user}">
									<div class="button">
										<span><input type="button" value="加入购物车"
											onclick="buyticket(${buytickesurface.get(2).tid},${buytickesurface.get(2).balance})" /></span>
									</div>
								</c:if>
								<c:if test="${empty session_user}">
									<div class="button">
					...
					<div class="product_desc">
						<h2>剧情 :</h2>
						<p>贝儿的父亲不小心闯进了野兽的领地，被囚禁在野兽的城堡里。为了救出父亲，贝儿只身犯险，答应与野兽同居于古堡并以此换回父亲。然而，贝儿因为一心想念着父亲，所以生活的并不愉快。
							贝儿找到机会逃走，可是却遇到了凶狠的狼群。危难关头，野兽及时出现解救了贝儿，自己却受了伤，贝儿心存感动，细心照顾野兽。此后，加斯顿因为追求贝儿失败，而设计让村民一起杀死野兽。
							贝儿伤心的亲吻了死去的野兽。而野兽则因为这个吻，解除了自己的诅咒，重新复活并变回了原来的人性。</p>
					</div>
				</div>
